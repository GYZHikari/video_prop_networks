...
'''
    File name: create_online_net_adaptive.py
...
def load_bnn_cnn_deploy_net(num_input_frames, height, width):
    # Create the prototxt
    net_proto = create_bnn_cnn_net(num_input_frames, height, width)
...
def load_bnn_deploy_net(num_input_points, height, width):
    # Create the prototxt
    net_proto = create_bnn_deploy_net(num_input_points, height, width)
